...
body{
  ...
  background:
    radial-gradient(1000px 700px at 20% -10%, rgba(120,170,255,.18), transparent 55%),
    radial-gradient(900px 600px at 90% 0%, rgba(255,120,190,.12), transparent 60%),
    var(--bg);
  color:var(--text);
  line-height:1.5;
}
...
.brand__mark{
  ...
  place-items:center;
  border-radius:12px;
  background: linear-gradient(135deg, rgba(120,170,255,.28), rgba(255,120,190,.22));
...
.hero__fade{
  ...
  inset:auto 0 0 0;
  height:90px;
  background: linear-gradient(to bottom, transparent, rgba(11,15,25,1));
  pointer-events:none;
}
...
.card--glow{
  background:
    radial-gradient(800px 420px at 10% 0%, rgba(120,170,255,.18), transparent 60%),
    radial-gradient(700px 420px at 100% 0%, rgba(255,120,190,.14), transparent 62%),
    rgba(255,255,255,.06);
}
...
.btn--shop{
  ...
  border-radius:999px;
  background: linear-gradient(135deg, #d6b56a, #f0d48a);
  color:#0b0f19;
  font-weight:800;
  letter-spacing:0.08em;
  text-transform:uppercase;
  border:1px solid rgba(240, 212, 138, 0.65);
  box-shadow:
    0 0 0 1px rgba(255,255,255,0.06) inset,
    0 10px 24px rgba(0,0,0,0.28),
    0 0 18px rgba(214,181,106,0.22);
...
.btn--shop:focus-visible{
  ...
  box-shadow:
    ...
    0 0 24px rgba(214,181,106,0.34);
}
...
/* Progress trigger and modal */
.progress-trigger-wrap{
  display:flex;
  flex-direction:column;
  align-items:center;
  justify-content:center;
...
.progress-trigger-link:hover img{
...
.progress-click-text:hover{
  opacity:0.85;
}

.progress-click-text:focus{
  outline:none;
  text-decoration:none;
  box-shadow:var(--focus);
  border-radius:10px;
...
.progress-modal-content{
  ...
  overflow:auto;
  background:
    radial-gradient(700px 320px at 10% 0%, rgba(120,170,255,.14), transparent 62%),
    radial-gradient(600px 320px at 100% 0%, rgba(255,120,190,.12), transparent 62%),
    rgba(15,20,34,.96);
  border:1px solid rgba(255,255,255,.12);
  border-radius:20px;
...
.progress-fill{
  height:100%;
  width:0%;
  background: linear-gradient(90deg, #f26a4b, #ff8762);
  border-radius:999px;
...
.ml-embedded form{
  ...
  border:1px solid rgba(214,181,106,0.25) !important;
...
.ml-embedded input[type="email"]{
  ...
  border:1px solid rgba(214,181,106,0.35) !important;
  color:#ffffff !important;
...
.ml-embedded input[type="submit"]{
  background: linear-gradient(135deg,#d6b56a,#bfa055) !important;
...
.ml-embedded input[type="submit"]:active{
  transform: translateY(1px) !important;
}
